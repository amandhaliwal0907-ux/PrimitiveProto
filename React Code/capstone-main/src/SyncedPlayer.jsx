// src/SyncedPlayer.jsx
// Plays a looping video alongside a voiceover audio track with synced controls.
// The video loops for the full duration of the audio (voiceover drives the timeline).
